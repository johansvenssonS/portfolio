...
const skills = [
  {
    ...
    description: 'React, TypeScript, Python, och moderna webbteknologier.',
  },
  {
    icon: Palette,
    title: 'Design',
    description: 'Skapar användarvänliga och estetiskt tilltalande gränssnitt.',
  },
  {
    icon: Zap,
    title: 'API Integration',
    description: 'Erfarenhet av att arbeta med externa API:er och datahämtning.',
  },
];
